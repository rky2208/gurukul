...
import PromptChips from "../../common/PromptChips";
import AvatarBadge from "../../common/AvatarBadge";
import TypingIndicator from "../../common/TypingIndicator";
import { useThemeMode } from "../../../context/ThemeModeContext";
import { PROVIDER_LABELS, SHOW_DEV_CONTROLS } from "../../../constants/providers";
...
export default function ChatPanel({
  ...
  const { input, setInput, loading, error, setError, firstName, handleSend } = useChatController({
    persona,
    messages,
    setMessages,
    chatDisabled,
